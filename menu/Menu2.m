...
@interface Menu2 ()<UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
...
- (void)setPageMenus:(NSArray *)pageMenus {
    ...
    [self.menuPageScrollView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.parentViewController.view.mas_bottom).with.offset(-49);
    }];
...
-(void)selecedPageWithItemIndexPath:(NSIndexPath*)indexPath {
    MenuItem *item = (MenuItem*)[self.menuPageCollectionView cellForItemAtIndexPath:indexPath];
    item.selected = YES;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    MenuItem *item = [collectionView dequeueReusableCellWithReuseIdentifier:itemReuseIdentifier forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self selecedPageWithItemIndexPath:indexPath];
    NSLog(@"Menu2: %ld selected",indexPath.row);
    [GlobalData sharedManager].menu2Selected=indexPath.row;
...
- (void)collectionView:(UICollectionView *)collectionView didDeselectItemAtIndexPath:(NSIndexPath *)indexPath {
    MenuItem *item = (MenuItem*)[collectionView cellForItemAtIndexPath:indexPath];
    item.selected = NO;
}
...
- (UICollectionView*)menuPageCollectionView {
    if (!_menuPageCollectionView) {
        ...
        [_menuPageCollectionView registerClass:[MenuItem class] forCellWithReuseIdentifier:itemReuseIdentifier];
